    ...
    <footer className="w-full bg-elegant-surface border border-elegant-border rounded-2xl text-elegant-text-primary px-6 py-5 md:py-6 mt-12 md:mt-16 shadow-sm" id="app-footer">
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        <button
          ...
          className="flex items-center space-x-2.5 px-3 py-1.5 rounded-xl text-white/70 hover:text-white hover:bg-elegant-surface-hover/60 border border-transparent hover:border-elegant-border/60 transition-all cursor-pointer group text-center"
        ...
        <p className="text-white/40 text-[11px] font-mono uppercase tracking-tight text-center">
          © 2026 SURCHI ECOSYSTEM. ALL RIGHTS RESERVED.
        </p>
      </div>
    </footer>
  );
